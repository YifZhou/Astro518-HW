\documentclass[preprint, 12pt]{aastex} \synctex=1
\usepackage{graphicx} \usepackage{natbib} \shorttitle{Instrumentation
Term Paper} \shortauthors{Yifan Zhou} \slugcomment{Astro 518 Term
Paper} \doublespace

\begin{document} \bibliographystyle{abbrvnat} \title{Comparison of
Spitzer IRAC and JWST NIRCam} \author{Yifan Zhou} \affil{University of
Arizona} \email{yifzhou@email.arizona.edu}
...
\begin{deluxetable}{lrrrr} \tablewidth{0pt} \tablecaption{IRAC
    Sensitivity (1 $\sigma$, $\mu$Jy),
    \citep{2004ApJS..154...10F}\label{tab:irac-sen}} \tablehead{Frame
    Time (s)&$3.6\mu$m&$4.5\mu$m&$5.8\mu$m&$8.0\mu$m} \startdata
...
\begin{figure} \centering \plotone{NIRCam_sensitivity}
...
\begin{figure} \centering \plotone{second_eclipse}
...
\begin{figure} \centering \plotone{irac-lc2}
...
\begin{figure}[h] \centering \plotone{NIRSpec}
